...
class Glo90(ElevationLayer):
    ...
    def to_url(tile_name: str) -> str:
        ...
        [northing]: e.g. S50_00, decimal degrees where the decimal part is always 00.
            In original files, this is the northing of the center of the bottom-most
            pixels, while in our files, because we removed the bottom-most pixels, the
            center of the new bottom-most pixels is one pixel-length (resolution) away
            to north.
        ...
        """
        return (
            f"https://copernicus-dem-90m.s3.amazonaws.com/{tile_name}/{tile_name}.tif"
        )
